...
class CmdAndPose(Node):
	...
	def __init__(self):
		super().__init__('minibot_cmd_pose')
		self.sub_pose = self.create_subscription(Pose, '/minibot/pose', self.callback_pose, 10)
		self.sub_cmdvel = self.create_subscription(Twist, '/mibibot/cmd_vel', self.callback_cmd, 10)
