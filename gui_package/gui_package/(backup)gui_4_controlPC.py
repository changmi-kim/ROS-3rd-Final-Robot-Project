...
#         self.M2 = CharingBot(2, bots_status[0], 100)
#         self.M3 = CharingBot(3, bots_status[0], 100)
...
#         # 테스트 데이터 전송용 버튼
#         self.pushbtn.clicked.connect(self.create_test_case)
    
#     def create_test_case(self):
#         text, ok = QInputDialog.getText(self, "입력", "데이터를 입력하세요:")
#         if ok and text:
#             # 입력받은 텍스트 처리
#             self.robot_schedule(text)
...
#             print(str(table))
#             table.setItem(0, 0, QTableWidgetItem("값 2"))
#             table.setItem(0, 1, QTableWidgetItem("값 2"))
#             table.setItem(1, 0, QTableWidgetItem("값 2"))
#             table.setItem(1, 1, QTableWidgetItem("값 2"))
